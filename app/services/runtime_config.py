...
CONFIG_KEYS: tuple[str, ...] = (
    ...
    "SCHOLAR_RAG_RERANKER_PROVIDER",
    "SCHOLAR_RAG_RERANKER_ENDPOINT",
    "SCHOLAR_RAG_RERANKER_API_KEY",
    "SCHOLAR_RAG_RERANKER_MODEL",
    "SCHOLAR_RAG_RERANKER_TIMEOUT_SECONDS",
    ...
    "SCHOLAR_SECONDARY_MODEL_BASE_URL",
    "SCHOLAR_SECONDARY_MODEL_API_KEY",
    "SCHOLAR_SECONDARY_MODEL_NAME",
    "SCHOLAR_RAG_BM25_K1",
    "SCHOLAR_RAG_BM25_B",
    "SCHOLAR_RAG_VECTOR_WEIGHT",
    "SCHOLAR_RAG_BM25_WEIGHT",
    "SCHOLAR_RAG_RECENCY_WEIGHT",
    "SCHOLAR_RAG_PREFERENCE_WEIGHT",
    "SCHOLAR_RAG_RECENCY_HALF_LIFE_DAYS",
...
SELECT_OPTIONS: dict[str, tuple[str, ...]] = {
    ...
    "SCHOLAR_RAG_RETRIEVAL_MODE": ("hybrid_rerank", "hybrid_rrf", "vector", "lexical"),
    "SCHOLAR_RAG_EMBEDDING_PROVIDER": ("qwen",),
    "SCHOLAR_RAG_RERANKER_PROVIDER": ("qwen", "none"),
    "SCHOLAR_RAG_CHUNK_STRATEGY": (
        "legacy_fixed",
        "structure_aware_v1",
        "formula_aware_v2",
...
DEFAULT_VALUES: dict[str, str] = {
    ...
    "SCHOLAR_RAG_RERANKER_PROVIDER": "qwen",
    "SCHOLAR_RAG_RERANKER_ENDPOINT": "https://dashscope.aliyuncs.com/api/v1/services/rerank/text-rerank/text-rerank",
    "SCHOLAR_RAG_RERANKER_MODEL": "qwen3.7-text-rerank",
    "SCHOLAR_RAG_RERANKER_TIMEOUT_SECONDS": "8.0",
    ...
    "SCHOLAR_SECONDARY_MODEL_BASE_URL": "",
    "SCHOLAR_SECONDARY_MODEL_NAME": "",
    "SCHOLAR_RAG_BM25_K1": "1.5",
    "SCHOLAR_RAG_BM25_B": "0.75",
    "SCHOLAR_RAG_VECTOR_WEIGHT": "0.35",
    "SCHOLAR_RAG_BM25_WEIGHT": "0.4",
    "SCHOLAR_RAG_RECENCY_WEIGHT": "0.1",
    "SCHOLAR_RAG_PREFERENCE_WEIGHT": "0.15",
    "SCHOLAR_RAG_RECENCY_HALF_LIFE_DAYS": "365",
    "SCHOLAR_LLM_BASE_URL": "",
    "SCHOLAR_LLM_MODEL": "",
